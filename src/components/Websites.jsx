...
import react01 from '../assets/img/rea_img1.png';
import react02 from '../assets/img/rea_img2.png';
import vue01 from '../assets/img/vue_img1.png';
import vue02 from '../assets/img/vue_img2.png';
         ...
         <div className={'projectContent up'}>
             <ul style={{"paddingBottom" : "30px"}}>
               <a href="https://soyeya.github.io/React_lush_/" target="_blank" rel="noreferrer noopener" style={{"color" : "#009dcd", "fontSize" : "1.5em", "fontWeight" : "900"}}>LUSH</a>
                ...
                <li style={{"marginTop" : "30px"}} className='webImg'><a href="https://soyeya.github.io/React_lush_/" rel="noreferrer noopener" target="_blank"><img src={react01} alt="react01"/></a></li>
             </ul>
           </div>
           <div className={'projectContent up'}>
             <ul style={{"paddingBottom" : "30px"}}>
               <a href="https://soyeya.github.io/React_tada/" target="_blank"rel="noreferrer noopener"  style={{"color" : "#01014a", "fontSize" : "1.5em", "fontWeight" : "900"}}>TADA</a>
                ...
                <li><p><strong>Skills</strong> React.js</p></li>
                <li style={{"marginTop" : "30px"}} className='webImg'><a href="https://soyeya.github.io/React_tada/" target="_blank" rel="noreferrer noopener"><img src={react02} alt="react02"/></a></li>
             </ul>
           </div>
         ...
         <div className={'projectContent up'}>
             <ul style={{"paddingBottom" : "30px"}}>
               <a href="https://soyeya.github.io/vueBiffsite/" target="_blank" rel="noreferrer noopener" style={{"color" : "#000", "fontSize" : "1.5em", "fontWeight" : "900"}}>BIFF</a>
                ...
                <li style={{"marginTop" : "30px"}} className='webImg'><a href="https://soyeya.github.io/vueBiffsite/" target="_blank" rel="noreferrer noopener"><img src={vue01} alt="vue01"/></a></li>
             </ul>
           </div>
           <div className={'projectContent up'}>
             <ul style={{"paddingBottom" : "30px"}}>
               <a href="https://soyeya.github.io/vueSchoolfood/" target="_blank" rel="noreferrer noopener" style={{"color" : "#aa0000", "fontSize" : "1.5em", "fontWeight" : "900"}}>SCHOOL FOOD</a>
                ...
                <li><p><strong>Skills</strong> Vue.js (ver.2)</p></li>
                <li style={{"marginTop" : "30px"}} className='webImg'><a href="https://soyeya.github.io/vueSchoolfood/" target="_blank" rel="noreferrer noopener"><img src={vue02} alt="vue02"/></a></li>
             </ul>
           </div>
         </div>
        </Page>
